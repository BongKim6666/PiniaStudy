...
class B {
  public name: string;
  private age: number; //如果想要在类外部访问private属性， 应该把private属性添加到get 和set方法中访问
...
class X {
  ...
  constructor(protected readonly age: number) {
...
abstract class Shape {
  ...
  abstract getPerimeter(): number; // 另一个抽象方法,,没有实现
}
